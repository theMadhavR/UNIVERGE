...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Storyboard', href: '/storyboard', icon: Timeline },
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 flex flex-col z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="relative">
            <button
              ...
              className="flex items-center w-full p-2 text-left rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500"
            >
            ...
            {/* Profile dropdown */}
            {profileDropdownOpen && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 py-1">
                <Link
                  to="/profile"
