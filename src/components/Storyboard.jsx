  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        ...
        <span className="ml-3 text-gray-600 dark:text-gray-400">Loading your storyboard...</span>
      </div>
    );
  }
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Career Storyboard</h1>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6 sticky top-6">
              ...
              <form onSubmit={handleSubmit(onSubmitItem)} className="space-y-4">
                ...
                <div>
                  ...
                  />
                  {errors.year && (
                    <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.year.message}</p>
                  )}
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Skills Gained</label>
                  <input
                    type="text"
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    type="button"
                    onClick={cancelEdit}
                    className="bg-gray-150 hover:bg-gray-250 dark:bg-slate-800 dark:hover:bg-slate-700 text-gray-900 dark:text-white font-medium py-2 px-4 rounded-lg transition-colors"
                  >
                    Cancel
                  </button>
                </div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6 mb-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Storyboard Title</label>
                <input
                  type="text"
                  {...register('title')}
                  defaultValue={storyboard?.title}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg font-semibold"
          ...
          <div className="space-y-6">
            {storyboard?.timeline_items && storyboard.timeline_items.length > 0 ? (
              storyboard.timeline_items.map((item, index) => (
                <div key={item.item_id} className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-6 hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-4 mt-1 text-sm text-gray-650 dark:text-gray-400">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="p-2 text-gray-400 hover:text-blue-650 dark:hover:text-blue-400 transition-colors"
                      >
                        <Edit className="h-4 w-4" />
                      </button>
                      <button
                        onClick={() => deleteItem(item.item_id)}
                        className="p-2 text-gray-400 hover:text-red-650 dark:hover:text-red-400 transition-colors"
                      >
                  ...
                  {item.lessons_learned && (
                    <div className="mb-4">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{item.lessons_learned}</p>
                    </div>
                  )}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {item.skills_gained.map((skill, idx) => (
                          <span key={idx} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-105 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
                            {skill}
                          </span>
                        ))}
                      </div>
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-slate-800 p-12 text-center">
                <Image className="h-16 w-16 text-gray-300 dark:text-gray-650 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Your Storyboard is Empty</h3>
